...
export default async function Project({params}:{
    ...
    return (
            <article className="max-w-[90%] lg:max-w-[70%] mt-8 mx-auto min-h-[70vh] md:min-h-[50vh]">
            ...
            <div className="mt-10">
                ...
                height={300}
                width={300}
                className="w-full md:w-4/5 md:mx-auto rounded-md"
                />
            </div>
            <div className="my-4 md:w-4/5 mx-auto">
                 <PortableText value={project.content}/>
            </div>
            <a href={project.url} className="md:hidden float-right my-6 block w-max border py-1 px-4 transition-all font-bold text-base font-playfair cursor-pointer text-dark-color dark:text-grey border-dark-color dark:border-grey hover:bg-lime hover:text-grey dark:hover:text-dark-color">View Project</a>
        </article>
    )
}
